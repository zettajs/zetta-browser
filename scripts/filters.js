...
angular.module('zetta').filter('encodeURIComponent', function() {
...
angular.module('zetta').filter('abc123', function(){
    return function(obj){
...
angular.module('zetta').filter('pluralize', function() {
